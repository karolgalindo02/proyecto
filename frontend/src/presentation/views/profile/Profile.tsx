    ...
    <View style={{ flex: 1 }}>
      ...
      >
        ...
        >
          ...
          {!!vm.user?.phone && (
            <Text style={styles.phone}>📱 {vm.user.phone}</Text>
          )}
        ...
        <Pressable style={[styles.row, { marginTop: 10 }]} onPress={onLogout}>
          ...
          <Text style={[styles.rowLabel, { color: AppColors.pinkText }]}>
            Cerrar sesión
          </Text>
          <View />
        </Pressable>
...
const styles = StyleSheet.create({
  ...
  avatarLetter: { color: "#FFF", fontSize: 38, fontFamily: "LexendDeca-Bold" },
  cameraBadge: {
    position: "absolute",
    right: -2,
    bottom: -2,
