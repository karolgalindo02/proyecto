      ...
      <View style={styles.filterRow}>
        {(["all", "unread"] as const).map((f) => (
          <Pressable
            ...
            style={[
              styles.chip,
              vm.filter === f && { backgroundColor: AppColors.primary },
            ]}
          >
            <Text
              style={{
                color: vm.filter === f ? "#FFF" : AppColors.primary,
      ...
      >
        {vm.loading ? (
          ...
          <View style={styles.empty}>
            ...
            <Text style={{ fontFamily: "LexendDeca-SemiBold", marginTop: 10 }}>
              Sin notificaciones
            </Text>
            <Text
              style={{
            ...
            >
              Aquí verás avisos de tu equipo.
            </Text>
          </View>
        ) : (
...
const styles = StyleSheet.create({
  ...
  empty: { fontFamily: "LexendDeca", alignItems: "center", padding: 40 },
});
